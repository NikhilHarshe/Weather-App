            ...
            <div className=" mt-5">
              {
                (token && user) ?
                  ...
                  (
                    <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Join Now</button>
                  )
              }
            </div>
          </div>
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 rounded-md shadow-blue-400 shadow-[0px_0px_30px_0px]">
            <img className="object-cover object-center rounded-lg" alt="hero" src={data?.eventImage} width={600} />
          </div>
        </div>
      </section>
